...
},{"@livechat/agent-app-widget-sdk":2,"if-emoji":3,"jquery-browserify":4}],2:[function(require,module,exports){
'use strict';
...
var messagesListener = function messagesListener(e) {
  ...
  switch (e.data.event_name) {
    ...
    case 'livechat:messages':
      ...
      return function () {
        var result1 = [];
        for (var _iterator3 = callbacks['messages'], _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
          var _ref3;
